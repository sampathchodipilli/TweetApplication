...
public class TweetController {
	...
	public ResponseEntity<?> postNewTweet(@PathVariable("username") String username, @RequestBody Tweets tweet){
		Response response = tweetService.postNewTweet(username, tweet);
		return new ResponseEntity<Response>(response, HttpStatus.OK);
	}
	
	@PutMapping("/{username}/update/{id}")
	public ResponseEntity<?> updateTweet(@PathVariable("username") String username, @PathVariable("id") String id, @RequestBody Tweets tweet) {
	...
	public ResponseEntity<?> replyToTweet(@PathVariable("username") String username, @PathVariable("id") String id, @RequestBody Reply reply) {
